...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Biography paragraph field in *Biography → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.default.primary.biography_paragraph
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  biography_paragraph: prismic.RichTextField;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Conent Type field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.conent_type
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  conent_type: prismic.SelectField<"Blog" | "Project">;
...
export interface ExperienceSliceDefaultPrimaryZoneItem {
  ...
  /**
   * date field in *Experience → Default → Primary → zone*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.zone[].date
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Career Tagline field in *Hero → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.career_tagline
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  career_tagline: prismic.KeyTextField;
...
/**
 * Item in *TechList → Default → Primary → Tech List Group*
 */
export interface TechListSliceDefaultPrimaryTechListGroupItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech List Group*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_list_group[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech List Group*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_list_group[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech List Group field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_list_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_list_group: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechListGroupItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryTechListGroupItem,
