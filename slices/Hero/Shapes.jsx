...
export default function Shapes() {
    return (
        <div className="row-span-1 row-start-1 -mt-9 aspect-square xl:col-span-1 xl:col-start-2 xl:mt-0">
...
function Geometries() {
    ...
    const materials = [
        ...
        new THREE.MeshStandardMaterial({ color: 0x44403E, roughness: 1 }),
        new THREE.MeshStandardMaterial({ color: 0x44403E, roughness: 1, metalness: 0.7 })
    ];
